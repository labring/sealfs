...
// impl<T> Drop for LinkedList<T> where T: std::fmt::Debug {
//     fn drop(&mut self) {
//         struct DropGuard<'a, T>(&'a mut LinkedList<T>) where T: std::fmt::Debug;
//         impl<'a, T> Drop for DropGuard<'a, T> where T: std::fmt::Debug {
//             fn drop(&mut self) {
